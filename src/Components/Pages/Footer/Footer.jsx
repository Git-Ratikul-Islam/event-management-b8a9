...
const Footer = () => {
      return (
            <div>
                  ...
                  <footer className="relative z-10 bg-[] pt-20 pb-10 lg:pt-[120px] lg:pb-20 overflow-hidden">
                                    ...
                                    <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                                          <div className="mb-10 w-full">
                                                ...
                                                <div className="mb-6 flex items-center">
                                                      <a
                                                            href="javascript:void(0)"
                                                            className="text-dark hover:bg-[#0866ff] hover:border-[#0866ff] mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                                      >
                                                            <svg
                                                                  width="8"
                                                                  height="16"
                                                      ...
                                                      <a
                                                            href="javascript:void(0)"
                                                            className="text-dark hover:bg-[#139ff1] hover:border-[#139ff1] mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                                      >
                                                            <svg
                                                                  width="16"
                                                                  height="12"
                                                      ...
                                                      <a
                                                            href="javascript:void(0)"
                                                            className="text-dark hover:bg-[#ff0000] hover:border-[#ff0000] mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                                      >
                                                            <svg
                                                                  width="16"
                                                                  height="12"
                                                      ...
                                                      <a
                                                            href="javascript:void(0)"
                                                            className="text-dark hover:bg-[#0077b0] hover:border-[#0077b0] mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                                                      >
                                                            <svg
                                                                  width="14"
                                                                  height="14"
                              ...
                              <span className="absolute left-0 bottom-0 z-[-1]">
                                    ...
                                    >
                                          ...
                                          <defs>
                                                ...
                                                >
                                                      <stop stop-color="#263b5c" stop-opacity="0.08" />
                                                      <stop offset="1" stop-color="#263b5c" stop-opacity="0" />
                                                </linearGradient>
                                          </defs>
                                    </svg>
                              </span>
                                    ...
                                    >
                                          ...
                                          <defs>
                                                <linearGradient
                                                      ...
                                                      gradientUnits="userSpaceOnUse"
                                                >
                                                      <stop stop-color="#263b5c" stop-opacity="0.31" />
                                                      <stop offset="1" stop-color="#263b5c" stop-opacity="0" />
                                                </linearGradient>
                                          </defs>
                                    </svg>
